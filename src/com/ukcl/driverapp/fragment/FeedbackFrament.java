...
public class FeedbackFrament extends BaseMapFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		feedbackFragmentView.findViewById(R.id.tvFeedbackskip)
				.setOnClickListener(this);
		Helper.getInstance().setFocusListener(etFeedbackComment, mapActivity);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		String value = ((bill.getBasePrice() == null) ? "00.00" : (bill.getBasePrice()));
		...
		String primary_amount = String.valueOf(decimalFormat.format(Double.parseDouble(bill.getDriver_fee()+"")));
		String secoundry_amount = String.valueOf(decimalFormat.format(Double
				.parseDouble(bill.getService_fee())));
