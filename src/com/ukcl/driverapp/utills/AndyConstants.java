...
public class AndyConstants {
	...
	public class ServiceType {
		...
		//private static final String HOST_URL = "http://52.26.255.47/";
		private static final String HOST_URL = "http://52.5.136.227/ukcl/public/";
		...
		public static final String RESPOND_REQUESTS_LATER = BASE_URL
				+ "respondrequestlater";
		
		public static final String BOOKING_STARTED = BASE_URL + "bookingisstarted";  
		public static final String CANCEL_BOOKING = BASE_URL + "bookingiscancelled"; 
		public static final String GET_ALL_SURGE = BASE_URL + "getallsurgearea"; 
		
		public static final String REQUEST_DETAILS = HOST_URL
				+ "user/getrequestdetail";
			
		public static final String GET_DRIVER_BOOKINGS = BASE_URL
				+ "getwalkerallbooking";
	...
	public class ServiceCode {
		...
		public static final int RESPOND_REQUEST_ADVANCE = 22;
		public static final int REQUEST_DETAILS = 23;
		public static final int BOOKING_DETAILS = 24;
		public static final int BOOKING_STARTED= 25;
		public static final int CANCEL_BOOKING = 26;
		public static final int SURGE_AREA = 27;
	...
	public class Params {
		...
		public static final String DEST_2_LATITUDE = "e_latitude";
		public static final String DEST_2_LONGITUDE = "e_longitude";
		...
		public static final String IS_LOGGING_OUT = "is_logging_out";
		
		
		// get booking details data
				//POST provider/getwalkerallbooking walker_id,advance_type = all,double,single later = 1
		public static final String DRIVER_ID = "walker_id";
		public static final String OWNER_ID = "owner_id";
		public static final String ADVANCE_TYPE = "advance_type";
		public static final String IS_ADVANCE = "later";
